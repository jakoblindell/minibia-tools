...
- **Show floor connections** (checkbox) - draws `floorConnections` on the current floor and lets you click a marker to jump to whichever floor it resolves to; ones labeled both ways by hand don't jump, since there's nothing to disambiguate which one you meant.
